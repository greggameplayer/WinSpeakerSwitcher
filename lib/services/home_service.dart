...
class HomeService {
  Home homeState = Home(defaultDevice: AudioDeviceExtended(), initialized: false, audioDeviceType: AudioDeviceType.output, audioDevices: [], mixerList: [], stateFetchAudioMixerPeak: false, volume: 0.0, fetchStatus: "Get", audioIcons: {});
