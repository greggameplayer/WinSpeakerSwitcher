...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  void initState() {
    ...
    Timer.periodic(const Duration(milliseconds: 1000), (timer) async {
      if (ref.read(mixerNotifierProvider.notifier).stateFetchAudioMixerPeak) {
        ref.read(mixerNotifierProvider.notifier).audioMixersUpdate();
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final AsyncValue<Mixer> mixerNotifier = ref.watch(mixerNotifierProvider);
    final AsyncValue<Map<String, List<int>>> iconsNotifier =
        ref.watch(iconsNotifierProvider);
    return homeNotifier.when(data: (home) {
      return mixerNotifier.when(
          data: (mixer) {
            return Scaffold(
              appBar: AppBar(
                      ...
                      children: [
                        ...
                        Flexible(
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTile(
                                      leading: (iconsNotifier.value!
                                              .containsKey(
                                                  home.audioDevices[index].id))
                                          ? Image.memory(
                                              ref
                                                  .read(iconsNotifierProvider
                                                      .notifier)
                                                  .getIcon((home
                                      ...
                                      title:
                                          Text(home.audioDevices[index].name),
                                      trailing: Row(
                        ...
                        SizedBox(
                          child: CheckboxListTile(
                            ...
                            value: mixer.stateFetchAudioMixerPeak,
                            controlAffinity: ListTileControlAffinity.leading,
                            onChanged: ref
                                .read(mixerNotifierProvider.notifier)
                        ...
                        Flexible(
                          flex: 3,
                          child: ListView.builder(
                              itemCount: mixer.mixerList.length,
                              itemBuilder: (context, index) {
                                return Column(
                                  children: [
                                    const Divider(
                                              ...
                                              children: [
                                                Slider(
                                                  ...
                                                  onChanged: (e) async => ref
                                                      .read(
                                                          mixerNotifierProvider
                                                              .notifier)
                                                      .onChangedProcessSlider(
                                                          e, index),
                                                ),
                                                Padding(
