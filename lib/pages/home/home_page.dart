                  ...
                  Flexible(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                                leading: (iconsNotifier.value!.containsKey(
                                        home.audioDevices[index].id))
                                    ? Image.memory(
                                        ref
                                            .read(
                                                iconsNotifierProvider.notifier)
                                            .getIcon(
                                                (home.audioDevices[index].id)),
                                        width: 32,
                                        height: 32,
                                ...
                                title: Text(home.audioDevices[index].name),
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                        icon: Icon((home.audioDevices[index]
                                                    .isActive ==
                                                true
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          Slider(
                                            value:
                                                home.mixerList[index].maxVolume,
                                            min: 0,
                                            max: 1,
                                            divisions: 25,
